...
<head>
    ...
    <title>Coverage for /Users/mac/.local/share/virtualenvs/Mariseco-aEBnUIKV/lib/python3.9/site-packages/admin_interface/__init__.py: 100%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>/Users/mac/.local/share/virtualenvs/Mariseco-aEBnUIKV/lib/python3.9/site-packages/admin_interface/__init__.py</b> :
...
<div id="source">
    ...
    <p id="t3" class="run"><span class="n"><a href="#t3">3</a></span><span class="t"><span class="nam">default_app_config</span> <span class="op">=</span> <span class="str">'admin_interface.apps.AdminInterfaceConfig'</span>&nbsp;</span><span class="r"></span></p>
</div>
<div id="footer">
    <div class="content">
        <p>
